...
def lstm_cell_forward(xt, a_prev, c_prev, parameters):
    ...
    print(("c_prev:  " + str(c_prev.shape)))
    print(("ft:  " + str(ft.shape)))
...
if __name__ == "__main__":
    ...
    #lstm_forward_test()
    #rnn_cell_backward_test()
    #rnn_backward_test()
    #lstm_cell_backward_text()
    lstm_backward_test()
